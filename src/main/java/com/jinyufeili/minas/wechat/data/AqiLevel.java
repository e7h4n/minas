...
public class AqiLevel {
    ...
    static {
        CN_AQI_LEVELS.add(new AqiLevel("优", "空气质量令人满意，基本无空气污染。\n各类人群可正常活动。", 0, 35.0, 0, 50));
        CN_AQI_LEVELS
                .add(new AqiLevel("良", "空气质量可接受，但某些污染物可能对极少数异常敏感人群健康有较弱影响。\n极少数异常敏感人群应减少户外活动。", 35, 75.0, 50, 100));
        CN_AQI_LEVELS
                .add(new AqiLevel("轻度污染", "易感人群症状有轻度加剧，健康人群出现刺激症状。\n儿童、老年人及心脏病、呼吸系统疾病患者应减少长时间、高强度的户外锻炼。", 75, 115.0,
                        100, 150));
        ...
        CN_AQI_LEVELS.add(new AqiLevel("严重污染", "健康人群运动耐受力降低，有明显强烈症状，提前出现某些疾病。\n儿童、老年人和病人应停留在室内，避免体力消耗，一般人群避免户外活动。", 250,
                350.0, 300, 400));
        CN_AQI_LEVELS.add(new AqiLevel("严重污染", "健康人群运动耐受力降低，有明显强烈症状，提前出现某些疾病。\n儿童、老年人和病人应停留在室内，避免体力消耗，一般人群避免户外活动。", 350,
                500.0, 400, 500));
    }
